...
from yolomanager import YoloDetectorWrapper
...
class App(QWidget):
    ...
    def update_image(self, cv_img) -> None:
        """Updates the image_label with a new opencv image, on frame update"""
        ...
        draw_fps(display_img, round(fps, 2))
...
if __name__ == "__main__": 
    ...
    parser.add_argument("--model", default="./saved_models/home_ball_weights_saved_model/home_ball_weights_integer_quant.tflite")
